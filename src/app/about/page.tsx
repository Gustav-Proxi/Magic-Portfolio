...
export default function About() {
  const structure = [
    ...
    // Adding the research section here
    {
      title: about.research.title,
      display: about.research.display,
      items: (about.research.publications || []).map((publication) => publication.title),
    },
  ];
    ...
    <Column maxWidth="m">
      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {/* Add research section display here */}
          {about.research.display && (
            <>
              <Heading as="h2" id={about.research.title} variant="display-strong-s" marginBottom="m"marginTop="40">
                {about.research.title}
              </Heading>
              <Column fillWidth gap="l">
                {about.research.papers && about.research.papers.length > 0 ? (
                  about.research.papers.map((publication, index) => (
                    <Column key={`${publication.title}-${index}`} fillWidth gap="4">
                      <Text id={publication.title} variant="heading-strong-l">
                        {publication.title}
                      </Text>
                      <Text variant="body-default-m" onBackground="neutral-weak">
                  ...
                  <Text>No publications available</Text>
                )}
              </Column>
            </>
          )}
